...
class SuperBizAgentApp {
    ...
    // 修正移动端浏览器地址栏变化导致的 100vh 高度抖动；PC 端不设置该变量
    initMobileViewportHeight() {
        ...
        if (typeof mobileQuery.addEventListener === 'function') {
            mobileQuery.addEventListener('change', setAppHeight);
        } else if (typeof mobileQuery.addListener === 'function') {
            mobileQuery.addListener(setAppHeight);
        }
    }
    ...
    initializeElements() {
        ...
        this.mobileModeIndicator = document.getElementById('mobileModeIndicator');
    ...
    bindEvents() {
        ...
        if (this.mobileMenuBtn && this.sidebar) {
            this.mobileMenuBtn.addEventListener('click', (e) => {
                e.stopPropagation();
                this.sidebar.classList.toggle('mobile-history-open');
            });
        }
        ...
        document.addEventListener('click', (e) => {
            ...
            if (this.sidebar && this.sidebar.classList.contains('mobile-history-open') &&
                !this.sidebar.contains(e.target)) {
                this.sidebar.classList.remove('mobile-history-open');
            }
        });
    ...
    updateUI() {
        ...
        if (this.currentModeText) {
            ...
            if (this.mobileModeIndicator) {
                this.mobileModeIndicator.textContent = `${modeNames[this.currentMode] || '快速'}模式`;
            }
        }
